...
["IMF_Freeze", {
    ...
    [{
        ...
        titleText ["<t color='#e5eb34' size='3'>Simulation disabled<br/>DON'T TOUCH ANYTHING</t><br/>You can check out our TBD Guide in the map screen for useful information in the meantime", "PLAIN", -1, true, true];
    }, [], 10] call CBA_fnc_waitandexecute;
}] call CBA_fnc_addEventHandler;
